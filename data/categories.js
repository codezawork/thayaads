const categories = {
  food: {
    ...
    videos: [
      ...
      { id: 'XYjMZXun7Dg', title: 'AJJ Halwa–II' },
      { id: 'cILkLk90rGw', title: 'AJJ Halwa-III' },
      { id: 'yis-PaIU1k4', title: 'Madha Milk-I' },
      { id: '6hW8BoYQ7TE', title: 'AJJ Maskoth Halwa' },
      { id: 'yn3e1M8OAU8', title: 'Madha Milk-II' },
      ...
      { id: 'zE67dykGvsQ', title: 'Saravana Salt-I' },
      { id: 'ptxsyXiRg7U', title: 'Saravana Salt-II' },
      { id: 'Xu-TPdwQ2oo', title: 'Saravana Salt-III' },
      { id: 'zE67dykGvsQ', title: 'Arasan Murukku' },
      { id: 'fkU_ec5EQhM', title: 'RMP Snacks' },
  ...
  personalCare: {
    ...
    videos: [
      ...
      { id: '8GBgGf0LloI', title: 'Merits Soaps' },
      { id: 'XXn_t7ko_UU', title: 'Merits Soap -II' },
      { id: 'AdtoqMzKosg', title: 'Solace Oil-Malayalam' },
      { id: '_iWPGLy3OzQ', title: 'ESOPE' },
      { id: '2EbTR9U_j2o', title: 'Duka Hebals -I' },
      { id: 'Ovli-AqGQHk', title: 'Durka Herbales-II' },
      { id: 'AhFjwuyQB7A', title: 'Durka Hebals-III' },
